...
-- 预设支出分类
-- ============================================
INSERT INTO bill_category (category_name, category_type, parent_id, enabled, sort_order) VALUES
-- 一级分类
('餐饮', 'EXPENSE', NULL, '1', 1),
('交通', 'EXPENSE', NULL, '1', 2),
('购物', 'EXPENSE', NULL, '1', 3),
...
INSERT INTO bill_category (category_name, category_type, parent_id, enabled, sort_order) VALUES
('早餐', 'EXPENSE', @canyin_id, '1', 1),
('午餐', 'EXPENSE', @canyin_id, '1', 2),
('晚餐', 'EXPENSE', @canyin_id, '1', 3);
